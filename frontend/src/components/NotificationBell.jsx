...
const VERB_META = {
  ...
  rfi_returned: {
    ...
    hoverBg:     "hover:bg-rose-50 dark:hover:bg-gray-700/60",
    groupBg:     "bg-rose-50/50 dark:bg-rose-950/20",
    groupBorder: "border-rose-100 dark:border-rose-900/40",
    groupLabel:  (n) => `${n} RFI${n !== 1 ? "s" : ""} returned to you`,
    singleLabel: "RFI returned — action required",
    itemLine:    (n) => `RFI #${n.rfi_number}: ${n.rfi_name}`,
    itemSub:     (n) => [
      n.project_number && `${n.project_number}`,
      n.actor_name     && `by ${n.actor_name}`,
    ].filter(Boolean).join(" · "),
    destination: (n) => `/rfi/${n.rfi_id}/${n.rfi_slug}`,
  },
  official_response: {
    ...
    hoverBg:     "hover:bg-purple-50 dark:hover:bg-gray-700/60",
    groupBg:     "bg-purple-50/50 dark:bg-purple-950/20",
    groupBorder: "border-purple-100 dark:border-purple-900/40",
    groupLabel:  (n) => `${n} official response${n !== 1 ? "s" : ""} submitted`,
    singleLabel: "Official response submitted",
    itemLine:    (n) => `RFI #${n.rfi_number}: ${n.rfi_name}`,
    itemSub:     (n) => [n.project_number, n.actor_name && `by ${n.actor_name}`].filter(Boolean).join(" · "),
    destination: (n) => `/rfi/${n.rfi_id}/${n.rfi_slug}`,
  },
  rfi_status_change: {
    Icon:        ArrowPathIcon,
    ...
    hoverBg:     "hover:bg-teal-50 dark:hover:bg-gray-700/60",
    groupBg:     "bg-teal-50/50 dark:bg-teal-950/20",
    groupBorder: "border-teal-100 dark:border-teal-900/40",
    groupLabel:  (n) => `${n} RFI status update${n !== 1 ? "s" : ""}`,
    singleLabel: "RFI status changed",
    itemLine:    (n) => `RFI #${n.rfi_number}: ${n.rfi_name}`,
    itemSub:     (n) => [n.project_number, n.actor_name && `by ${n.actor_name}`].filter(Boolean).join(" · "),
    destination: (n) => `/rfi/${n.rfi_id}/${n.rfi_slug}`,
  },
  watcher_activity: {
    ...
    hoverBg:     "hover:bg-sky-50 dark:hover:bg-gray-700/60",
    groupBg:     "bg-sky-50/50 dark:bg-sky-950/20",
    groupBorder: "border-sky-100 dark:border-sky-900/40",
    groupLabel:  (n) => `${n} RFI update${n !== 1 ? "s" : ""} (watching)`,
    singleLabel: "Activity on watched RFI",
    itemLine:    (n) => `RFI #${n.rfi_number}: ${n.rfi_name}`,
    itemSub:     (n) => [n.project_number].filter(Boolean).join(" · "),
    destination: (n) => `/rfi/${n.rfi_id}/${n.rfi_slug}`,
  },
  rfi_overdue: {
    ...
    groupBg:     "bg-red-50/50 dark:bg-red-950/20",
    groupBorder: "border-red-100 dark:border-red-900/40",
    groupLabel:  (n) => `${n} overdue RFI${n !== 1 ? "s" : ""}`,
    singleLabel: "RFI is overdue",
    itemLine:    (n) => `RFI #${n.rfi_number}: ${n.rfi_name}`,
    itemSub:     (n) => [n.project_number, n.due_date && `due ${fmtDate(n.due_date)}`].filter(Boolean).join(" · "),
    destination: (n) => `/rfi/${n.rfi_id}/${n.rfi_slug}`,
  },
  rfi_comment: {
    Icon:        ChatBubbleLeftRightIcon,
    ...
    hoverBg:     "hover:bg-indigo-50 dark:hover:bg-gray-700/60",
    groupBg:     "bg-indigo-50/50 dark:bg-indigo-950/20",
    groupBorder: "border-indigo-100 dark:border-indigo-900/40",
    groupLabel:  (n) => `${n} new comment${n !== 1 ? "s" : ""}`,
    singleLabel: "New comment on RFI",
    itemLine:    (n) => `RFI #${n.rfi_number}: ${n.rfi_name}`,
    itemSub:     (n) => [n.project_number, n.actor_name && `by ${n.actor_name}`].filter(Boolean).join(" · "),
    destination: (n) => `/rfi/${n.rfi_id}/${n.rfi_slug}`,
  },
