    ...
    <div className="max-w-md w-full rounded-2xl bg-white p-6 shadow-lg border border-gray-100 hover:shadow-xl transition duration-300">
      ...
      <div className="space-y-4">
        <div className="flex items-start gap-3 rounded-lg bg-gray-50 p-3">
          <BriefcaseIcon className="h-5 w-5 text-blue-900 mt-0.5" />
          <div>
        ...
        <div className="flex items-start gap-3 rounded-lg bg-gray-50 p-3">
          <EnvelopeIcon className="h-5 w-5 text-blue-900 mt-0.5" />
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">
              Email
            </p>
        ...
        <div className="flex items-start gap-3 rounded-lg bg-gray-50 p-3">
          <BuildingOfficeIcon className="h-5 w-5 text-blue-900 mt-0.5" />
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">
              Company
            </p>
