  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <div
        ...
        className="min-h-[2.75rem] flex flex-wrap items-center gap-2 px-3 py-2 rounded-md bg-white
                   outline-1 -outline-offset-1 outline-gray-300 cursor-pointer
                   focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"
      >
        {/* Placeholder */}
        {selected.length === 0 && (
          <span className="flex items-center gap-1.5 text-sm text-gray-400 select-none">
            <UserGroupIcon className="h-4 w-4" />
            {members.length === 0 ? "Select a project first" : "Add assignees…"}
          </span>
        )}
        ...
        {selected.map((member) => (
          <span
            ...
            className="group flex items-center gap-1.5 pl-1 pr-1.5 py-0.5
                       ...
                       text-indigo-900 text-sm select-none"
          ...
          >
            ...
            <button
              ...
              className="rounded-full p-0.5 text-indigo-400
      ...
      {open && (
        <div
          ...
          className="absolute z-30 mt-1 w-full rounded-md bg-white
